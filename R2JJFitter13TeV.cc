...
double signalScaler=1000.0*0.01/10000.; // assume signal cross section of 0.01pb=10fb and 3000/pb of luminosity (The factor 10000. is the number of gen events that is set to 10000. for all samples in the interpolation script
