...
CMSSW_DIR="/mnt/t3nfs01/data01/shome/vscheure/CMSSW_7_4_7"
BASEDIR=`pwd`
...
mkdir datacards                                                                                         
mkdir workspaces                                                                                        
cp /mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/datacards/${DATACARD}.txt datacards/  
cp /mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/workspaces/${SIGWS}.root workspaces/
cp /mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/workspaces/${BKG}.root workspaces/     
...
combine ${DATACARD}.txt -M Asymptotic -m ${MASS} -n test --rMax 100 --rMin 0.000001  --minimizerTolerance 0.0000001 --rAbsAcc 0. >> myout.txt 2>>myerr.txt
mv  higgs*.root /mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/test/${OUTFILENAME} >> myout.txt 2>>myerr.txt
mv myerr.txt ../
mv myout.txt ../
