...
void AddSigData(RooWorkspace* w, Float_t mass, int signalsample, std::vector<string> cat_names) {
  ...
  TString inDir   = "/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/MiniTrees/Signal_VV_13TeV/";
...
void AddBkgData(RooWorkspace* w, std::vector<string> cat_names) {
  ...
  TString inDir   = "/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/MiniTrees/Data_VV_13TeV/";
  if(CHANNEL==2) inDir   = "/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/MiniTrees/Data_qV_13TeV/";
...
//     std::cout<< "works"<< c << std::endl;
    ...
    fitresult[c] = bkg_fitTmp->fitTo(*data[c], Strategy(1),Minimizer("Minuit2","migradimproved"),Minos(kFALSE), Range(minMassFit,maxMassFit),SumW2Error(kTRUE), Save(kTRUE),PrintEvalErrors(-1));
    //************************************************//
...
void MakePlots(RooWorkspace* w, Float_t mass, vector<RooFitResult*> fitresults, TString signalname, std::vector<string> cat_names) {
  ...
  for (int c = ncat_min; c < ncat_min+ncat; ++c) {
    ...
    ctmp->SaveAs("/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/plots/sigmodel_"+signalname+TString::Format("%d_%s.pdf", iMass, cat_names.at(c).c_str()));
    ctmp->SaveAs("/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/plots/sigmodel_"+signalname+TString::Format("%d_%s.root", iMass, cat_names.at(c).c_str()));
  ...
  c4->SaveAs(TString::Format("/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/plots/backgrounds_log.pdf"));
  ...
  c5->SaveAs(TString::Format("/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/plots/backgrounds.pdf"));
...
void MakeSigWS(RooWorkspace* w, const char* fileBaseName, TString signalname, std::vector<string> cat_names) {
  ...
  TString wsDir   = "/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/workspaces/"+filePOSTfix;
...
void MakeDataCard_1Channel(RooWorkspace* w, const char* fileBaseName, const char* fileBkgName, int iChan, TString signalname, int signalsample, std::vector<string> cat_names, double mass) {
  ...
  TString cardDir = "/mnt/t3nfs01/data01/shome/vscheure/DijetCombineLimitCode/datacards/"+filePOSTfix;
  ...
  //  HP+HP
  if( ((signalsample==0)||(signalsample==1)||(signalsample==2)||(signalsample==3)||(signalsample==4)||(signalsample==5)) && (iChan==2 ||iChan==4 ||iChan==6) )
    scaleFactor*=(scaleFactorHP*scaleFactorLP);
  
  //  HP+LP
  if( ((signalsample==0)||(signalsample==1)||(signalsample==2)||(signalsample==3)||(signalsample==4)||(signalsample==5)) && (iChan==1||iChan==3||iChan==0||iChan==5||iChan==7))
...
void X2VVFitter_without_btags(double mass, int signalsamples=0, int channel=0,std::string altfunc="",std::string postfix="")
{
  filePOSTfix=postfix;
  if(signalsamples==0){
