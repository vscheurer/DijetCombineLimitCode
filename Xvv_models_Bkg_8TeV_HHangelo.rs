...
jj_HH_sig_m0_CMS_jj_VVHP[2000.0, 900.0, 3100.0];
jj_HH_sig_sigma_CMS_jj_VVHP[100, 50.0, 1000.0];
jj_HH_sig_alpha_CMS_jj_VVHP[ 0.8, 0.0, 3.0]; 
jj_HH_sig_n_CMS_jj_VVHP[130, 0.00001, 1000.0]; 
jj_HH_sig_gsigma_CMS_jj_VVHP[100, 50.0, 1000.0];
jj_HH_sig_frac_CMS_jj_VVHP[0.5, 0.3, 1.0];


jjGaussSigHH_CMS_jj_VVHP = Gaussian(mgg, jj_HH_sig_m0_CMS_jj_VVHP, jj_HH_sig_gsigma_CMS_jj_VVHP);
jjCBSigHH_CMS_jj_VVHP    = CBShape(mgg, jj_HH_sig_m0_CMS_jj_VVHP, jj_HH_sig_sigma_CMS_jj_VVHP, jj_HH_sig_alpha_CMS_jj_VVHP, jj_HH_sig_n_CMS_jj_VVHP);
HH_jj_CMS_jj_VVHP      = AddPdf(jjGaussSigHH_CMS_jj_VVHP, jjCBSigHH_CMS_jj_VVHP, jj_HH_sig_frac_CMS_jj_VVHP);

jj_HH_sig_m0_CMS_jj_VVLP[2000.0, 900.0, 3100.0];
jj_HH_sig_sigma_CMS_jj_VVLP[100, 50.0, 1000.0];
jj_HH_sig_alpha_CMS_jj_VVLP[ 0.8, 0.0, 3.0]; 
jj_HH_sig_n_CMS_jj_VVLP[130, 0.00001, 1000.0]; 
jj_HH_sig_gsigma_CMS_jj_VVLP[100, 50.0, 1000.0];
jj_HH_sig_frac_CMS_jj_VVLP[0.5, 0.3, 1.0];

jjGaussSigHH_CMS_jj_VVLP = Gaussian(mgg, jj_HH_sig_m0_CMS_jj_VVLP, jj_HH_sig_gsigma_CMS_jj_VVLP);
jjCBSigHH_CMS_jj_VVLP    = CBShape(mgg, jj_HH_sig_m0_CMS_jj_VVLP, jj_HH_sig_sigma_CMS_jj_VVLP, jj_HH_sig_alpha_CMS_jj_VVLP, jj_HH_sig_n_CMS_jj_VVLP);
HH_jj_CMS_jj_VVLP      = AddPdf(jjGaussSigHH_CMS_jj_VVLP, jjCBSigHH_CMS_jj_VVLP, jj_HH_sig_frac_CMS_jj_VVLP);

jj_HH_sig_m0_CMS_jj_VVNP[2000.0, 900.0, 3100.0];
jj_HH_sig_sigma_CMS_jj_VVNP[100, 50.0, 1000.0];
jj_HH_sig_alpha_CMS_jj_VVNP[ 0.8, 0.0, 3.0]; 
jj_HH_sig_n_CMS_jj_VVNP[130, 0.00001, 1000.0]; 
jj_HH_sig_gsigma_CMS_jj_VVNP[100, 50.0, 1000.0];
jj_HH_sig_frac_CMS_jj_VVNP[0.5, 0.3, 1.0];

jjGaussSigHH_CMS_jj_VVNP = Gaussian(mgg, jj_HH_sig_m0_CMS_jj_VVNP, jj_HH_sig_gsigma_CMS_jj_VVNP);
jjCBSigHH_CMS_jj_VVNP    = CBShape(mgg, jj_HH_sig_m0_CMS_jj_VVNP, jj_HH_sig_sigma_CMS_jj_VVNP, jj_HH_sig_alpha_CMS_jj_VVNP, jj_HH_sig_n_CMS_jj_VVNP);
HH_jj_CMS_jj_VVNP      = AddPdf(jjGaussSigHH_CMS_jj_VVNP, jjCBSigHH_CMS_jj_VVNP, jj_HH_sig_frac_CMS_jj_VVNP);

jj_HH_sig_m0_CMS_jj_qVHP[2000.0, 900.0, 3100.0];
jj_HH_sig_sigma_CMS_jj_qVHP[100, 50.0, 1000.0];
jj_HH_sig_alpha_CMS_jj_qVHP[ 0.8, 0.0, 3.0]; 
jj_HH_sig_n_CMS_jj_qVHP[130, 0.00001, 1000.0]; 
jj_HH_sig_gsigma_CMS_jj_qVHP[100, 50.0, 1000.0];
jj_HH_sig_frac_CMS_jj_qVHP[0.5, 0.3, 1.0];

jjGaussSigHH_CMS_jj_qVHP = Gaussian(mgg, jj_HH_sig_m0_CMS_jj_qVHP, jj_HH_sig_gsigma_CMS_jj_qVHP);
jjCBSigHH_CMS_jj_qVHP    = CBShape(mgg, jj_HH_sig_m0_CMS_jj_qVHP, jj_HH_sig_sigma_CMS_jj_qVHP, jj_HH_sig_alpha_CMS_jj_qVHP, jj_HH_sig_n_CMS_jj_qVHP);
HH_jj_CMS_jj_qVHP      = AddPdf(jjGaussSigHH_CMS_jj_qVHP, jjCBSigHH_CMS_jj_qVHP, jj_HH_sig_frac_CMS_jj_qVHP);

jj_HH_sig_m0_CMS_jj_qVLP[2000.0, 900.0, 3100.0];
jj_HH_sig_sigma_CMS_jj_qVLP[100, 50.0, 1000.0];
jj_HH_sig_alpha_CMS_jj_qVLP[ 0.8, 0.0, 3.0]; 
jj_HH_sig_n_CMS_jj_qVLP[130, 0.00001, 1000.0]; 
jj_HH_sig_gsigma_CMS_jj_qVLP[100, 50.0, 1000.0];
jj_HH_sig_frac_CMS_jj_qVLP[0.5, 0.3, 1.0];

jjGaussSigHH_CMS_jj_qVLP = Gaussian(mgg, jj_HH_sig_m0_CMS_jj_qVLP, jj_HH_sig_gsigma_CMS_jj_qVLP);
jjCBSigHH_CMS_jj_qVLP    = CBShape(mgg, jj_HH_sig_m0_CMS_jj_qVLP, jj_HH_sig_sigma_CMS_jj_qVLP, jj_HH_sig_alpha_CMS_jj_qVLP, jj_HH_sig_n_CMS_jj_qVLP);
HH_jj_CMS_jj_qVLP      = AddPdf(jjGaussSigHH_CMS_jj_qVLP, jjCBSigHH_CMS_jj_qVLP, jj_HH_sig_frac_CMS_jj_qVLP);


jj_HH_sig_m0_CMS_jj_qVNP[2000.0, 900.0, 3100.0];
jj_HH_sig_sigma_CMS_jj_qVNP[100, 50.0, 1000.0];
jj_HH_sig_alpha_CMS_jj_qVNP[ 0.8, 0.0, 3.0]; 
jj_HH_sig_n_CMS_jj_qVNP[130, 0.00001, 1000.0]; 
jj_HH_sig_gsigma_CMS_jj_qVNP[100, 50.0, 1000.0];
jj_HH_sig_frac_CMS_jj_qVNP[0.5, 0.3, 1.0];

jjGaussSigHH_CMS_jj_qVNP = Gaussian(mgg, jj_HH_sig_m0_CMS_jj_qVNP, jj_HH_sig_gsigma_CMS_jj_qVNP);
jjCBSigHH_CMS_jj_qVNP    = CBShape(mgg, jj_HH_sig_m0_CMS_jj_qVNP, jj_HH_sig_sigma_CMS_jj_qVNP, jj_HH_sig_alpha_CMS_jj_qVNP, jj_HH_sig_n_CMS_jj_qVNP);
HH_jj_CMS_jj_qVNP      = AddPdf(jjGaussSigHH_CMS_jj_qVNP, jjCBSigHH_CMS_jj_qVNP, jj_HH_sig_frac_CMS_jj_qVNP);
